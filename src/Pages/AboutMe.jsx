        ...
        <div className="hero--section--content--box about--section--box">
          <div className="hero--section--content">
            ...
            <p className="hero--section-description">
                I'm a <span style={{fontWeight:"bold"}}>Frontend Web Developer</span> with 1.2 years of solid experience in front-end technologies. 
                I've worked on complex projects, enhancing my understanding of React.js and JavaScript concepts.
