  ...
  return (
    ...
    <footer className="footer--container">
      ...
      <div className="footer--link--container">
        ...
        <div>
          <img src={Logo} alt="Logoipsum" height="50px" width="120px"/>
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            ...
            <li>
              <a
                href="https://www.instagram.com/prabhat_mishra01"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://github.com/PRABHAT0700"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
               <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Octicons-mark-github.svg/2048px-Octicons-mark-github.svg.png" style={{heigh:"32px", width:"32px"}}/>
              </a>
            </li>

            <li>
              <a
                href="https://www.linkedin.com/in/prabhat-mishra-4b2a2326b"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
